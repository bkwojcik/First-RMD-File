...
# This is done to prepare the data for visualization using ggplot2.
ggplot(data.frame(x = stopping_times), aes(x)) +
  
   # Create a histogram of the stopping times with binwidth = 1.
